...
function Creative() {
  ...
  return (
    <div className="md:py-10 py-5 md:px-[120px] px-4 ">
      ...
      <div className="py-5">
        <Link href="/contact">
          <button className="bg-amber-400 md:px-1 px-2 md:py-1 py-1 rounded hover:opacity-70 transition-transform duration-300 hover:scale-105 hover:-translate-y-1 ">
            Get in Touch
          </button>
        </Link>
      </div>
