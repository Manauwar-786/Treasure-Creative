...
export const Contact = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:items-center md:justify-center px-4 md:pb-10 pb-2">
      <h2 className="text-amber-400 md:text-3xl text-xl font-bold md:py-5 ">
        Contact
      </h2>
      <Link href="/">
