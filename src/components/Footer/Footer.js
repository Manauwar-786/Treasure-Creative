   ...
   <div className="flex flex-col justify-baseline py-4 md:px-[120px] px-4 bg-gradient-to-r from-yellow-700 via-yellow-600 to-gray-500">
    <div>
        <div className='flex gap-2'>
          <h2 className='md:text-3xl text-xl text-amber-400 font-bold'>Treasure</h2> 
          <span className='md:text-3xl text-xl font-bold'>Creatives</span>
        </div>
        <p className='font-mono md:py-5 py-3'>Treasure Creatives works to transform conceptual ideas into meaningful results. We serve brands to help them expand their business digitally and build customer loyalty.</p> 
    </div>
